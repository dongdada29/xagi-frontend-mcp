...
export const MONOREPO_CONFIG = {
  ...
  templates: {
    "react-next": {
      ...
      port: "3000",
      description:
        "React + Next.js + TypeScript + Tailwind CSS 模板 - 基于 Next.js 14 的全栈应用开发模板",
    },
    "react-vite": {
      name: "react-vite",
      ...
      port: "3000",
      description:
        "React + Vite + TypeScript 模板 - 基于 Vite 的现代化 React 开发模板",
    },
    "vue3-vite": {
      name: "vue3-vite",
      ...
      port: "4000",
      description:
        "Vue 3 + Vite + TypeScript 模板 - 基于 Vite 的现代化 Vue 3 开发模板",
    },
  },
  sharedConfig: {
    packageManager: "pnpm",
